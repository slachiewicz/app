  ...
  },
  {
    ...
    config: {
      ...
      handler: function (request, reply) {
        ...
        sentEmail.tokens = request.auth.credentials.tokens;
        ...
        var counter = 0;
        allEmails.forEach(function (obj) {

          sendEmail(obj.email, sentEmail, function (err, response) {

            if (err) {
              return reply('somethine went wrong');
            } 
