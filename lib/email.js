      ...
      handler: function (request, reply) {
        ...
        if (!validationObject.error) {
          ...
          client.get({
            ...
            return reply.view('email', {emails: emails, userProfile:userProfile, user:user});
          });          
        }else {
  ...
  },
  {
    ...
    config: {
      ...
      handler: function (request, reply) {
        ...
        console.log('++++',candidatesFirstNames)
        ...
        arrCandidateObj.forEach(function (obj) {
          ...
          sendEmail(obj.email, sentEmail, profile, user, function (err, response) {
            if (err) {
              console.log(err);
              return reply('Please re-login to the app');
            } 
