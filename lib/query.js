...
var searchedSkills = require('./helpers/skills_searched.js');
var completeListSkills = require('./helpers/complete_list_skills.js');
...

    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          console.log('skills from reqest.query', skills);
            ...
            client.search({
              ...
              body: {
                ...
                response.hits.hits.forEach(function (element) {
                  ...
                  var listSkills = searchedSkills(skills, contact.skills);

                  contact.listSkills = completeListSkills(listSkills, contact.skills);
