...
exports.init = function (port, next) {
  ...
  server.register([{register: HapiAuthGoogle, options: opts}, Authentication, Inert, Vision, Home, CandidateView, Assets, Api, Search, Login, Permission, GetGoogleLoginUrl], function (err) {
     // $lab:coverage:off$
    if (err) {
      return next(err);
    }
