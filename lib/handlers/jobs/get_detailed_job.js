...
const getSectors = require('../../database-helpers/elasticsearch/get_sectors');
    ...
    getJob(request.params.id, function (err, job) {
      ...
      getCountries(job.address.countryID, function (errCountries, country) {
        ...
        getClients(function (errClients, clients) {
          ...
          job.businessSectors.data.forEach(function (id) {
            
            console.log(id)
            getSectors(id, function (errSector, sector) {
