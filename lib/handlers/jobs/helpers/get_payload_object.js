  ...
  var owner = {};
    ...
    if (payload.businessSectors) {
      if (typeof payload.businessSectors === "string") {
        businessSectors.data = [payload.businessSectors];
      } else {
    ...
    var timestampStartDate = new Date(payload.startDate).getTime() || null;
    var timestampDateEnd = new Date(payload.dateEnd).getTime() || null;
